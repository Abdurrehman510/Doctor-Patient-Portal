      ...
      <main className="pt-16 pb-12 flex items-center justify-center min-h-[calc(100vh-8rem)]">
        <div className="max-w-md w-full mx-auto p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl transition-all duration-300 hover:shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-2">Please enter your credentials to login</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <a href="/forgot-password" className="text-sm text-primary hover:text-primary-dark dark:hover:text-primary-light">Forgot password?</a>
              </div>
              <input
                type="password"
                {...register('password', {
          ...
          <div className="mt-8 text-center text-sm text-gray-500 dark:text-gray-400">
            ...
            <a href="/signup" className="font-medium text-primary hover:text-primary-dark dark:hover:text-primary-light transition-colors duration-200">
              Sign up
            </a>
          </div>
        </div>
